...
public class ClosedFragment extends Fragment implements AlertsListener.LoadAlertsListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_closed, container, false);
    ...
    public void onAlertsReceived(List<Alert> alertList) {
        if (alertList.size() != 0){
            ...
            progressBar.setVisibility(View.GONE);
            Toast.makeText(getActivity(), "There are no Closed alerts", Toast.LENGTH_LONG).show();
        }
